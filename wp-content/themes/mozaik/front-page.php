<?php echo get_header(); ?>
    ...
    <main class="main">
        <?php if (have_rows('modules')): ?>
            ...
            <div class="home-bg-holder">
                <?php while (have_rows('modules')) : the_row();
                    if (get_row_layout() == 'featured_customer_story_block') :
            ...
            <?php while (have_rows('modules')) : the_row();
                if (get_row_layout() == 'block_with_form') :
                ...
                elseif (get_row_layout() == 'hero_banner_simple_block') :
