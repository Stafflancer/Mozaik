...
<?php if ($s_heading || $s_tagline || $s_content || $s_button || $s_image) {
    wp_enqueue_style('hero_banner_home_block_styles', get_template_directory_uri() . '/static/css/modules/hero_banner_home_block/hero_banner_home_block.css', '', '', 'all');
