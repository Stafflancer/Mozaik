...
<?php if ($s_heading || $s_content || have_rows('s_list')) {
    wp_enqueue_style('skewed_column_list_block_styles', get_template_directory_uri() . '/static/css/modules/skewed_column_list_block/skewed_column_list_block.css', '', '', 'all');
    ...
    <section
            class="skewed_column_list_block
            <?php
        ...
        <div class="container">
            ...
            <div class="section-holder">
                ...
                <?php if (have_rows('s_list')) { ?>
                    <div class="list">
                        <?php while (have_rows('s_list')) : the_row();
